...
const Contact = () => {
    return (
        <div className='contact d-flex pt-5 mt-5 justify-content-between w-50 mx-auto'>
            <div className='contact__item'>
                <Link to='https://github.com/AlenaYarmak' target='_blank'>
            ...
            <div className='contact__item'>
                <Link to='https://www.linkedin.com/in/olena-yarmak/' target='_blank'>
            ...
            <div className='contact__item'>
                <Link to='mailto:olena.yarmak.mail@gmail.com'>
